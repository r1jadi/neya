...
export function DiscoveryEventBrowser({ events, savedEventIds, city }: Props) {
  const [query, setQuery] = useState(""); const [window, setWindow] = useState("all"); const [category, setCategory] = useState(""); const [genre, setGenre] = useState(""); const [date, setDate] = useState(""); const [access, setAccess] = useState("all"); const [showFilters, setShowFilters] = useState(false);
