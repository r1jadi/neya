...
const neonClassName =
  "relative inline-flex h-12 items-center justify-center overflow-hidden rounded-full bg-gradient-to-r from-sky-400 via-cyan-300 to-fuchsia-400 px-8 text-sm font-bold text-[#09090b] shadow-[0_0_32px_rgba(56,189,248,0.45)] transition-shadow hover:shadow-[0_0_48px_rgba(244,114,182,0.45)]";
